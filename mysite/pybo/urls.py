...
urlpatterns = [
    ...
    path('comment/vote/question/<int:comment_id>/', vote_views.comment_vote_question, name='comment_vote_question'),
    path('comment/vote/answer<int:comment_id>/', vote_views.comment_vote_answer, name='comment_vote_answer')
]
